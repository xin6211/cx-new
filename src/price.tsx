    ...
    return (
        <div className="w-full">
            ...
            <div className="flex flex-row justify-between mt-[3.2rem] pad:mt-0 ph:grid ph:grid-rows-[8.8rem_1fr] ph:grid-cols-2 ph:gap-8">
                <div className="flex flex-col justify-around bg-bggray border border-black rounded-regular drop-shadow-cardShadow w-[70%] py-[3rem] px-[2.4rem] ph:col-span-2 ph:row-start-2 ph:w-full ph:px-[1.6rem] ph:py-[2rem] ph:justify-between">
                ...
                <div className="bg-bggray border border-black rounded-regular w-[20%] h-[16rem] drop-shadow-cardShadow flex flex-row justify-center pad:w-[26%] ph:h-full ph:w-full ph:col-start-2">
            ...
            <div className="flex flex-row justify-between mt-[3.2rem] pad:mt-0 ph:grid ph:grid-rows-[8.8rem_1fr] ph:grid-cols-2 ph:gap-8 ph:mt-0">
                <div className="bg-bggray border border-black rounded-regular w-[20%] h-[16rem] drop-shadow-cardShadow flex flex-row justify-center pad:w-[26%] ph:h-full ph:w-full ph:col-start-1">

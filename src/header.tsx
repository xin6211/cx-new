...
function MenuItem({
    ...
    return (
        <div
            ...
            className="flex items-center bg-white px-8 py-4 w-full rounded-2xl"
        >
            {svgEle}
...
function Header() {
    ...
    return (
        <div className="fixed top-0 left-0 z-30 bg-bgblack w-[100lvw] h-[4rem] px-[12rem] flex flex-row justify-between items-center pad:px-pxpad pad:w-full ph:px-pxph ph:h-[5rem] maxpad:px-[12rem] padpm:px-[8rem]">
            <div className="flex flex-row items-center">
                ...
                <div className="flex flex-row items-center justify-evenly border ml-4 border-white w-[20rem] h-[80%] rounded-md py-[6px] pl-[4px] pad:w-[17rem] ph:hidden">
            ...
            >
                <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M1 7.99976H17" stroke="white" strokeWidth="2" strokeLinecap="round" />
                    <path d="M1 15H17" stroke="white" strokeWidth="2" strokeLinecap="round" />
                </svg>
            </div>
            ...
            <div
                style={{ height: menuH, padding: menuP, border: menuB }}
                className="ease-in-out duration-300 hidden ph:flex flex-col justify-between h-[32vh] absolute top-[5rem] right-1 bg-[#FAFAFA] px-8 py-16 border border-borderlinear rounded-2xl overflow-hidden"
            >
                <MenuItem
                    text="Home"
                    svgEle={
                        <svg className="mr-4" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M16.4791 8.09167V8.09166H16.475H13.1083C12.4943 8.09166 12.2307 7.97773 12.1131 7.87365C12.0159 7.78767 11.9 7.60101 11.9 7.09166V3.31666C11.9 2.81281 12.0153 2.62466 12.114 2.53694C12.2324 2.43181 12.4966 2.31666 13.1083 2.31666H16.475C17.0868 2.31666 17.351 2.43181 17.4693 2.53694C17.568 2.62466 17.6833 2.81281 17.6833 3.31666V7.09999C17.6833 7.60432 17.5678 7.79147 17.4703 7.87782C17.3533 7.98129 17.0905 8.09551 16.4791 8.09167Z"
                                stroke="black"
                                strokeWidth="1.3"
                            />
                            <path
                                d="M17.6833 13.1083V16.475C17.6833 17.0724 17.5593 17.3236 17.4414 17.4414C17.3236 17.5593 17.0724 17.6833 16.475 17.6833H13.1083C12.5109 17.6833 12.2598 17.5593 12.1419 17.4414C12.0241 17.3236 11.9 17.0724 11.9 16.475V13.1083C11.9 12.5109 12.0241 12.2598 12.1419 12.1419C12.2598 12.0241 12.5109 11.9 13.1083 11.9H16.475C17.0724 11.9 17.3236 12.0241 17.4414 12.1419C17.5593 12.2598 17.6833 12.5109 17.6833 13.1083Z"
                                stroke="black"
                                strokeWidth="1.3"
                            />
                            <path
                                d="M6.8951 8.09167V8.09166H6.89102H3.52435C2.91028 8.09166 2.64668 7.97773 2.52909 7.87365C2.43194 7.78767 2.31602 7.60101 2.31602 7.09166V3.31666C2.31602 2.81281 2.43131 2.62466 2.53004 2.53694C2.64837 2.43181 2.91259 2.31666 3.52435 2.31666H6.89102C7.50277 2.31666 7.767 2.43181 7.88533 2.53694C7.98405 2.62466 8.09935 2.81281 8.09935 3.31666V7.09999C8.09935 7.60432 7.98384 7.79147 7.88627 7.87782C7.76936 7.98129 7.5065 8.09551 6.8951 8.09167Z"
                                stroke="black"
                                strokeWidth="1.3"
                            />
                            <path
                                d="M8.09935 13.1083V16.475C8.09935 17.0724 7.97528 17.3236 7.85744 17.4414C7.7396 17.5593 7.48842 17.6833 6.89102 17.6833H3.52435C2.92695 17.6833 2.67577 17.5593 2.55793 17.4414C2.44009 17.3236 2.31602 17.0724 2.31602 16.475V13.1083C2.31602 12.5109 2.44009 12.2598 2.55793 12.1419C2.67577 12.0241 2.92695 11.9 3.52435 11.9H6.89102C7.48841 11.9 7.7396 12.0241 7.85744 12.1419C7.97528 12.2598 8.09935 12.5109 8.09935 13.1083Z"
                                stroke="black"
                                strokeWidth="1.3"
                            />
                        </svg>
                ...
                <MenuItem
                    ...
                    svgEle={
                        <svg className="mr-4" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M9.76498 9.22308C5.30107 9.22308 1.62695 7.64847 1.62695 5.42535C1.62695 3.20222 5.30107 1.62759 9.76498 1.62759C14.2289 1.62759 17.903 3.2022 17.903 5.42535C17.903 7.64847 14.2289 9.22308 9.76498 9.22308ZM9.76498 8.13802C13.6908 8.13802 16.8179 6.79783 16.8179 5.42533C16.8179 4.05287 13.6908 2.71267 9.76498 2.71267C5.83916 2.71267 2.71203 4.05287 2.71203 5.42535C2.71203 6.79781 5.83916 8.13802 9.76498 8.13802Z"
                                fill="black"
                                stroke="black"
                                strokeWidth="0.3"
                            />
                            <path
                                d="M3.89496 7.09389L4.36 8.07426C3.27625 8.58833 2.71203 9.20432 2.71203 9.76563C2.71203 11.1381 5.83916 12.4783 9.76498 12.4783C13.6908 12.4783 16.8179 11.1381 16.8179 9.76563C16.8179 9.17167 16.1855 8.51831 14.9892 7.99167L15.4264 6.99858C16.9731 7.6795 17.903 8.64009 17.903 9.76563C17.903 11.9888 14.2289 13.5634 9.76498 13.5634C5.30107 13.5634 1.62695 11.9888 1.62695 9.76563C1.62695 8.69243 2.47363 7.76811 3.89496 7.09389Z"
                                fill="black"
                                stroke="black"
                                strokeWidth="0.3"
                            />
                            <path
                                d="M3.90502 11.4294L4.36865 12.4104C3.27949 12.9252 2.71201 13.543 2.71201 14.1059C2.71201 15.4784 5.83916 16.8186 9.76498 16.8186C13.6908 16.8186 16.8179 15.4784 16.8179 14.1059C16.8179 13.5177 16.1978 12.8709 15.0216 12.3463L15.4636 11.3553C16.988 12.0353 17.903 12.9896 17.903 14.1059C17.903 16.329 14.2289 17.9037 9.76498 17.9037C5.30107 17.9037 1.62695 16.329 1.62695 14.1059C1.62695 13.0301 2.47762 12.104 3.90502 11.4294Z"
                                fill="black"
                                stroke="black"
                                strokeWidth="0.3"
                            />
                ...
                <MenuItem
                    ...
                    svgEle={
                        <svg className="mr-4" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_1071_2091)">
                                <path d="M2.5 2.5L8.39167 16.6417L10.4833 10.4833L16.6417 8.39167L2.5 2.5Z" stroke="#121212" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M10.834 10.8333L15.834 15.8333" stroke="#121212" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </g>
                            <defs>
                ...
                <div className="flex items-center border border-borderlinear rounded-[999px] bg-white px-8 py-4">
                    <svg className="mr-4" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M1 2C1 1.44772 1.44772 1 2 1H7C7.55228 1 8 1.44772 8 2V10C8 10.5523 7.55228 11 7 11H2C1.44772 11 1 10.5523 1 10V2Z"
                            stroke="black"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                        />
                        <path
                            d="M12 10C12 9.44772 12.4477 9 13 9H18C18.5523 9 19 9.44772 19 10V18C19 18.5523 18.5523 19 18 19H13C12.4477 19 12 18.5523 12 18V10Z"
                            stroke="black"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                        />
                        <path
                            d="M12 2C12 1.44772 12.4477 1 13 1H18C18.5523 1 19 1.44772 19 2V4C19 4.55228 18.5523 5 18 5H13C12.4477 5 12 4.55228 12 4V2Z"
                            stroke="black"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                        />
                        <path
                            d="M1 16C1 15.4477 1.44772 15 2 15H7C7.55228 15 8 15.4477 8 16V18C8 18.5523 7.55228 19 7 19H2C1.44772 19 1 18.5523 1 18V16Z"
                            stroke="black"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                            strokeLinejoin="round"
